...
├── frontend/     SPA con React + Vite (PWA con soporte offline)
├── docs/         Documentación (manual de usuario, despliegue, arquitectura offline)
├── docker-compose.yml
...
- [Arquitectura offline](docs/OFFLINE_ARCHITECTURE.md)
